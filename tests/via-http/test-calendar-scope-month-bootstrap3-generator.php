...
$Calendar->viewing_date = (isset($_GET['viewdate']) ? strip_tags($_GET['viewdate']) : date('Y-m'));
...
<html>
    <head>
        <meta charset="utf-8">
        <title>Calendar scope month - Bootstrap generator</title>
    ...
    <body>
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12">
                    <h1>Calendar scope month - Bootstrap generator</h1>
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    ...
                    <?php
                    $Calendar->first_day_of_week = 4;
                    echo $Calendar->display('month', '\\Rundiz\\Calendar\\Generators\\Bootstrap3');
                    $Calendar->clear();
                    ?> 
                </div>
            </div>
